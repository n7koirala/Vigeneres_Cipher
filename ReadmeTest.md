...
- `avx2/SHE_tests/Cipher_Plain_depth`, `avx512/SHE_tests/Cipher_Plain_depth`, `HEAAN_GPU_avx2/SHE_tests/Cipher_Plain_depth`, `HEAAN_GPU_avx512/SHE_tests/Cipher_Plain_depth`: Contains data for ciphertext-plaintext operations for tests run using different depth levels for SHE (test not run for HEAAN_GPU_avx2 and HEAAN_GPU_avx512) 

Data is structured in the same manner for avx512, HEAAN_GPU_avx2 and HEAAN_GPU_avx512 architectures.
...
- `avx2/FHE_tests/HEAAN`: Contains data for FHE tests run using HEAAN library for avx2
	...
	- `avx2/FHE_tests/HEAAN/bootstrappingHEAAN`: Contains data for homomorphic addition, multiplication, rotation, linear transform, dot product, polynomial evaluation and bootstrapping timing tests run using FHE presets for HEAAN 
...
- `avx512/FHE_tests/HEAAN/bootstrappingHEAAN`: Contains data for homomorphic addition, multiplication, rotation, linear transform, dot product, polynomial evaluation and bootstrapping timing tests run using FHE presets for HEAAN on avx512
